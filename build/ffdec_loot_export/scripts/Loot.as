package
{
   ...
   public class Loot
   {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              if(!_loc19_)
                              {
                                 ...
                                 if(this.var_1.clientEnt && this.superAnim.m_TheDO.y < this.var_1.clientEnt.appearPosY)
                                 {
                                    this.superAnim.m_TheDO.y = this.var_1.clientEnt.appearPosY;
                                 }
                                 while(true)
                                 {
      ...
      public function method_1300() : Boolean
      {
         ...
         if(this.var_1.clientEnt && this.superAnim && this.superAnim.m_TheDO && this.superAnim.m_TheDO.y < this.var_1.clientEnt.appearPosY)
         {
            this.superAnim.m_TheDO.y = this.var_1.clientEnt.appearPosY;
         }
