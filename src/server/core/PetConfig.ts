...
export class PetConfig {
    ...
    static TRAINING_TIME = [0, 0, 180, 1800, 7200, 14400, 28800, 57600, 86400, 115200, 144000, 172800, 201600, 230400, 259200, 345600, 345600, 345600, 345600, 345600, 345600];
