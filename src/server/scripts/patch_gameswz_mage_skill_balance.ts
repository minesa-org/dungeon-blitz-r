...
function patchPowerModBlock(modName: string, block: string, stats: PatchStats): string {
  ...
  const descriptions: Record<string, string> = {
    ChilblainsDmg: "Soguk Yaralari Hasari artar.@Soguk Yaralari Hasari:, +4%, +12%, +24%, +40%, +50%",
    DryIce: "Buz koklemesi kirilmadan once uzmanliginin belirli bir yuzdesi kadar hasar sogurur.@Hasar (% Uzmanlik):, 75%, 150%, 250%, 375%, 500%",
    IceCasket: "Dondurma etkisi kirilmadan once uzmanliginin belirli bir yuzdesi kadar hasar sogurur.@Hasar (% Uzmanlik):, 100%, 200%, 300%, 400%, 500%",
    ColdHeart: "Buz Soku cezasini azaltir.@Ceza:, -10%, -20%, -30%, -40%, -50%",
    IgniteCrit: "Lanetli hedeflere karsi zehir hasari bonusu kazanir.@Zehir Hasari Bonusu:, 2%, 4%, 6%, 8%, 10%",
    PoisonDmg: "Zehir Hasari artar.@Zehir Hasari:, +6%, +12%, +18%, +24%, +30%",
  };
